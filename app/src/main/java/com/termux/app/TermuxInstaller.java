...
final class TermuxInstaller {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                 ...
                 //   mainOptions.btnConsole.setEnabled(true);
    ...
    static URL determineZipUrl() throws MalformedURLException {
        ...
        return new URL("https://github.com/StevenSalazarM/Termux-api-bluetooth/releases/download/binary3/bootstrap-" + archName + ".zip");
        //return new URL("https://github.com/StevenSalazarM/Termux-api-bluetooth/releases/download/binary3/bootstrap-i686.zip")
